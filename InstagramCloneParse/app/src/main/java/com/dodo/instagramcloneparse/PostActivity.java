...
public class PostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commentText = findViewById(R.id.PostActivityCommentText);
        imageView = findViewById(R.id.PostActivityImageText);
        ...
        object.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if (e != null){
                    ...
                    Toast.makeText(getApplicationContext(),"Succesfully download",Toast.LENGTH_LONG).show();
